...
module.exports = {
  ...
  fn: function({ model, req }, exits) {
    ...
    const { includedModels, unsupported } = toInclude.reduce((acc, alias) => {
      const assoc = find(req.options.associations, (o) => o.alias === alias);
      if (!assoc) {
      ...
      return Object.assign({}, acc, {
        includedModels: [].concat(acc.includedModels, { alias: assoc.alias, model: req._sails.models[relationIdentity] })
      });
